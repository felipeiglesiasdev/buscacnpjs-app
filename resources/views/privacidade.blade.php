...
<section class="max-w-4xl mx-auto px-4 py-12 space-y-6">
    ...
    <div class="bg-white border border-slate-200 shadow-sm rounded-xl p-6 space-y-4 text-slate-700 leading-relaxed">
        ...
        <p>Se você é responsável pelo CNPJ, pode solicitar a remoção clicando em "Solicitar Remoção de Dados" na página do resultado. A exclusão do resultado dos mecanismos de busca pode levar até 14 dias após o processamento.</p>
    </div>
</section>
@endsection
